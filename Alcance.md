...
El registro e inicio de sesión en la plataforma requiere de un nombre, una contraseña y una dirección de correo electrónico validada. Se restringe la existencia de nombres duplicados y la creación de más de una cuenta por usuario.
...
- Estructura temporal y pausas: El partido se divide mediante tres pausas programadas por cada cuarto de tiempo total (las cuales no interrumpen la continuidad para el usuario): primera pausa de hidratación, medio tiempoy segunda pausa de hidratación.
